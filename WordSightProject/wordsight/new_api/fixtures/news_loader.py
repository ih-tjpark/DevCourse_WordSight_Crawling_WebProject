...
with open('new_api/fixtures/crawling_data_final.json', 'r', encoding='UTF-8') as f:
...
with open('new_api/fixtures/crawling_data_final_result.json', 'w', encoding='UTF-8') as f:
